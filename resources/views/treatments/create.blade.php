                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control border" name="title" id="title" placeholder="Titulo" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" type="file" id="treatment_file" name="treatment_file" required>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
